 ...
 */
    public LibrerieMainFrame(Proxy proxy, String cf) {
        ...
        topPanel.setBackground(new Color(41, 128, 185)); // Stesso colore del topPanel di HomeMainFrame
        ...
        // Imposta colore di sfondo e testo dei bottoni come in HomeMainFrame
        ...
        // Effetto hover per i bottoni come in HomeMainFrame
        ...
        for (Libro libro : risultati) {
            JPanel libroPanel = new JPanel(new BorderLayout()) {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    // Bordo arrotondato e sfondo come HomeMainFrame
